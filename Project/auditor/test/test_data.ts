...
import { AuditRequest } from "../src/requests/Audit";
import { Configuration } from "common/config/types";
...
const auditCert1Base = {
  ...auditCert1RawBase,
  signature: sign(auditCert1RawBase, PRIVATE_KEY)
};
export const auditCert1: ARPKICert<AuditionCertificate> = {
  ...auditCert1Base,
  type: "AuditionCertificate",
  signatures: [
    sign(auditCert1Base, PRIVATE_KEY),
    sign(auditCert1Base, PRIVATE_KEY)
  ]
};
...
const genReq2Attrs = {
  cert: auditCert1Base as Partial<ARPKICert<AuditionCertificate>>,
  type: "GenerateRequest",
  nonce: 1
};
export const generateRequest2: GenerateRequest<AuditionCertificate> = {
  ...genReq2Attrs,
  type: "GenerateRequest",
...
export const generateResponse2: GenerateResponse<AuditionCertificate> = {
  ...genResp2Attr,
  type: "GenerateResponse",
...
export const auditRequest: AuditRequest = {
  applicationUrl: auditCert1.application,
  configuration,
  deploymentVersion: 12345,
  properties: [],
  resources: auditCert1.resources
};

export const deleteRequest: DeleteRequest = {
  applicationUrl: auditRequest.applicationUrl,
  configuration
};

export const getSignatureRequest: GetSignatureRequest = {
